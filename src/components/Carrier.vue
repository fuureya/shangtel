  ...
  <div>
    ...
    <section class="py-24 bg-white border-b border-gray-100">
      <div class="container mx-auto px-6 text-center max-w-4xl">
        ...
        <h2 class="text-4xl lg:text-5xl font-black text-gray-900 mb-8 tracking-tight">{{ currentCarrierData.intro.title }}</h2>
    ...
    <section class="py-24 bg-zinc-50 relative overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-[0.03] pointer-events-none">
          <div class="absolute inset-0 bg-[url('/img/map.png')] bg-center bg-cover"></div>
      </div>
      <div class="container mx-auto px-6 relative">
        <div class="text-center mb-16">
          <h2 class="text-4xl lg:text-5xl font-black text-gray-900 mb-4 tracking-tight">{{ currentCarrierData.whyJoinUs.title }}</h2>
        ...
        <div class="grid md:grid-cols-3 gap-10">
          <div v-for="(card, index) in currentCarrierData.whyJoinUs.cards" :key="index"
            class="group bg-white p-10 rounded-2xl border border-gray-100 shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <h3 class="text-2xl font-black text-gray-900 mb-4">{{ card.title }}</h3>
            <p class="text-gray-500 font-medium leading-relaxed">{{ card.content }}</p>
          </div>
        </div>
      </div>
    </section>
