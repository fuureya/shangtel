      ...
      <div class="grid lg:grid-cols-2 min-h-screen">
        ...
        <div class="relative flex items-center justify-center p-8 lg:p-16">
          <div class="relative">
            ...
            <div class="absolute -top-4 -left-4 w-24 h-24 bg-blue-500/20 rounded-full blur-xl animate-pulse"></div>
            <div class="absolute -bottom-8 -right-8 w-32 h-32 bg-indigo-500/20 rounded-full blur-xl animate-pulse delay-1000"></div>

            <!-- Main Image -->
            <div class="relative overflow-hidden rounded-2xl shadow-2xl group">
              <img
                src="/img/infra/satelite.jpg"
                alt="Infrastruktur Shangtel"
