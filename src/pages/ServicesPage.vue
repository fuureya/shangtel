    ...
    <main class="bg-gray-50">
        ...
        <section class="relative bg-gradient-to-b from-white to-gray-50 pt-24 pb-20 lg:pt-32 lg:pb-28">
            ...
            <div class="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 tracking-tight font-semi-bold">
                    <span
                        ...
                        <div class="flex flex-col lg:flex-row items-center gap-10 lg:gap-16"
                            ...
                            <div class="w-full lg:w-1/2">
                                <div
                                    ...
                                    <a :href="getWhatsAppLink(service.title)" target="_blank"
                                        class="inline-flex items-center mt-8 text-blue-600 font-semibold group/btn">
                                        {{ currentContent.cta }}
